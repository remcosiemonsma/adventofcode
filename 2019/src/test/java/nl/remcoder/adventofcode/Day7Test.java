...
class Day7Test {
    ...
    void testPart1Input() throws Exception {
        ...
        assertEquals(22012, testSubject.handlePart1(input));
    }
    ...
    void testPart2Case1() throws Exception {
        ...
        assertEquals(139629729, testSubject.handlePart2(input));
    }
    ...
    void testPart2Case2() throws Exception {
        ...
        assertEquals(18216, testSubject.handlePart2(input));
    }
    ...
    void testPart2Input() throws Exception {
        ...
        assertEquals(4039164, testSubject.handlePart2(input));
    }
}