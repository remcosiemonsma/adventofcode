...
class Day8Test {
    ...
    void testPart1Input() throws Exception {
        assertEquals(493, testSubject.handlePart1(
                Files.lines(Paths.get("../aoc-inputs/2021/day8/input"))));
    }
    ...
    void testPart2Case1() {
        ...
        assertEquals(5353, testSubject.handlePart2(input.lines()));
    }
    ...
    void testPart2Case2() {
        ...
        assertEquals(61229, testSubject.handlePart2(input.lines()));
    }
